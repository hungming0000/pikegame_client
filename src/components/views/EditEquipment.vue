<template>
  <div class="modal-overlay">
      ...
      <div class="modal-body">
        <div class="cbtn-wrap">
          <form class="form-signup" action="" method="post" name="form">
            <label for="blue_equipmentid">藍方設備編號</label>
            <b-field style="width: 50%; margin-left: 25%">
              <b-input
                v-model="blue_equipmentid"
                placeholder="請輸入藍方設備編號"
                required
              ></b-input>
            </b-field>

            <label for="red_equipmentid">紅方設備編號</label>
            <b-field style="width: 50%; margin-left: 25%">
              <b-input
                v-model="red_equipmentid"
                placeholder="請輸入紅方設備編號"
                required
              ></b-input>
            </b-field>

            <br />
            <b-button type="submit" variant="success" @click="SetEquipment"
              >儲存</b-button
            >
          </form>
        </div>
    ...
    <div id="eetclose" class="close btn-close" @click="$emit('close-modal')">
...
export default {
  ...
  methods: {
    ...
    SetEquipment() {
      ...
      axios
        .post(url + "/Pikegame/Equipmentsetting/EditEquipmentsetting", {
        ...
        .then((response) => {
          ...
          if (response.data.isSuccess == true) {
            document.documentElement.querySelector("#eetclose").click();
            this.reload();
          } else {
