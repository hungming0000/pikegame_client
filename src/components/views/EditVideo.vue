...
export default {
  ...
  methods: {
    ...
    async GetVideosettingById() {
      ...
      await axios
        .post(
          url + "/Pikegame/Videosetting/GetVideosettingById",
          JSON.stringify(this.videoid)
        )
        .then((response) => {
          this.loading = false;
          if (response.data.isSuccess == true) {
            ...
            this.videotitle= response.data.Data[0].videotitle;
            this.videodescription= response.data.Data[0].videodescription;
