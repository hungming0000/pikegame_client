          ...
          <form class="form-signup" action="" method="post" name="form">
            <span class="row">
              ...
              /> -->
                <section>
                  <b-field>
                    <b-radio v-model="bluehitposition" native-value="頭" type="is-success"> 頭 </b-radio>
                  </b-field>
                  <b-field>
                    <b-radio v-model="bluehitposition" native-value="軀幹" type="is-success">
                      軀幹
                    </b-radio>
                  </b-field>
                  <b-field>
              ...
              <section>
                  <b-field>
                    <b-radio v-model="redhitposition" native-value="頭"  type="is-success"> 頭 </b-radio>
                  </b-field>
                  <b-field>
                    <b-radio v-model="redhitposition" native-value="軀幹"  type="is-success">
                      軀幹
                    </b-radio>
                  </b-field>
                  <b-field>
